...
CONFIG_DATA = {  # setting name: (display name, description, default value, gui object type)
    ...
    "flush_timeout":           ("Flush Timeout",                "EMBED and DELETE tasks are processed in batches, however, if there are no new tasks after this many seconds, all the remaining tasks will be processed at once.", 5.0),
    "task_timeout":           ("Task Timeout",                 "Maximum time (in seconds) allowed for a task to complete before it is marked as FAILED.", 300),
